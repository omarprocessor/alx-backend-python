...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org: str, resp: Dict, mocked_fxn: MagicMock) -> None:
        """Test that org method returns correct organization data."""
    ...
    def test_has_license(self, repo: Dict, key: str, expected: bool) -> None:
        """Test has_license checks license correctly."""
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        """Patch requests.get and provide test payload responses."""
        route_payload = {
    ...
    def test_public_repos_with_license(self) -> None:
        """Test public_repos filters by license key when provided."""
        self.assertEqual(
    ...
    def tearDownClass(cls) -> None:
        """Stop patched requests.get after all tests run."""
